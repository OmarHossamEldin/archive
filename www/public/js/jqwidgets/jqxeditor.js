    ...
    b.extend(b.jqx._jqxEditor.prototype, {
        ...
        createInstance: function (f) {
            ...
            if (d == true || d == "true") {
                ...
                var i = b(
                    "<div class='jqx-editor-toolbar-container' unselectable='on' aria-label='Formatting options' role='toolbar'><div class='jqx-editor-toolbar'></div>"
                );
                ...
                var g = b(
                    "<div class='jqx-editor'><div class='jqx-editor-container'><div class='jqx-editor-toolbar-container' aria-label='Formatting options' role='toolbar'><div class='jqx-editor-toolbar'></div></div><div class='jqx-editor-content'><iframe  src='javascript:\"<html></html>\"' allowtransparency='true' frameborder='0'></iframe></div></div></div>"
                );
                j.widget = g;
                j.widget[0].className =
                    j.widget[0].className + " " + j.element.className;
                try {
                ...
                var k = function () {
                    ...
                    j.addHandler(j.iframe, "load", function () {
                        ...
                        if (o > 1) {
                            ...
                            var q = b(
                                "<iframe  src='javascript:\"<html></html>\"' allowtransparency='true' frameborder='0'></iframe>"
                            ).appendTo(j.content);
                            j.iframe = g.find("iframe");
                            k();
                        }
                    ...
                    var l = b.jqx.browser.msie
                        ? "::selection{color: #fff; background: #328EFD;};::-moz-selection{color: #fff; background: #328eD;};::selection:window-inactive {background: #c7c7c7; color: #000;}::-moz-selection:window-inactive {background: #c7c7c7; color: #000;}html{font-size:13px; height:100%;}body{padding-top:1px;margin-top:-1px; padding-right: 1px; overflow-x: hidden;word-wrap: break-word;-webkit-nbsp-mode: space;-webkit-line-break: after-white-space;"
                        : "";
                    j.editorDocument.write(
                        "<!DOCTYPE html><html><head><meta charset='utf-8' /><style>html,body{padding:0; margin:0; font-size: 13px; font-family: " +
                            j.fontFamily +
        ...
        refresh: function (d) {
            ...
            if (m.content) {
                ...
                m.toolbarContainer.addClass(
                    m.toThemeProperty("jqx-widget-header")
                );
                m.toolbarContainer.addClass(
                    m.toThemeProperty("jqx-editor-toolbar-inline")
                );
            ...
            if (
                (m.toolbarPosition == "top" && n != 0) ||
                (m.toolbarPosition == "bottom" && n != 1)
            ) {
            ...
            if (h !== false) {
                        ...
                        switch (u.type) {
                            case "list":
                                ...
                                var A = function (R, Q, S) {
                                    if (u.command == "formatblock") {
                                        return (
                                            "<" +
                                            S +
                                            ' unselectable="on" style="padding: 0px; margin: 0px;">' +
                                            Q +
                                            "</" +
                                            S +
                                            ">"
                                        ...
                                        if (u.command == "fontname") {
                                            return (
                                                '<span unselectable="on" style="font-family: ' +
                                                S +
                                                ';">' +
                                                Q +
                                                "<span>"
                                            ...
                                            if (u.command == "fontsize") {
                                                return (
                                                    '<span unselectable="on" style="font-size: ' +
                                                    S +
                                                    ';">' +
                                                    Q +
                                                    "<span>"
                                ...
                                var t = function () {
                                    ...
                                    var R =
                                        "<div unselectable='on' style='margin-top: 0px; padding:0px;' class='" +
                                        Q +
                                        "'></div>";
                                    return R;
                                };
                                var C =
                                    u.command == "formatblock" ||
                                    u.command == "fontname" ||
                                    u.command == "fontsize";
                                var z = u.value || [];
                                var N = new Array();
                                ...
                                if (u.command == "fontname") {
                                    ...
                                    if (u.command == "formatblock") {
                                        ...
                                        b.each(z, function () {
                                            if (
                                                this.label.indexOf("Header") >=
                                                0
                                            ) {
                                                var Q = this.label.replace(
                                                    "Header",
                                                    m.localization.Header
                                                );
                                            } else {
                                                var Q =
                                                    m.localization[this.label];
                                            }
                                            N.push({
                                                label: Q,
                                                value: this.value,
                                ...
                                var P = {
                                    ...
                                    rtl: m.rtl,
                                    selectionRenderer:
                                        u.command == "fontsize" ? t : null,
                                    renderer: C ? A : null,
                                };
                                var D =
                                    "jqx-disableselect " +
                                    m.toThemeProperty(
                                        "jqx-editor-dropdownlist"
                                    ) +
                                    " " +
                                    m.toThemeProperty(
                                ...
                                m.addHandler(w, "mousedown", function (R) {
                                    if (
                                        b(".jqx-editor-dropdownpicker").length >
                                        0
                                    ) {
                                        b(
                                            ".jqx-editor-dropdownpicker"
                                        ).jqxDropDownButton("close");
                                    }
                                    if (
                                        b(".jqx-editor-dropdownlist").length > 0
                                    ) {
                            ...
                            case "colorPicker":
                                ...
                                var B = b(
                                    '<div unselectable="on" style="padding-top: 4px;"></div>'
                                ).attr("id", "picker-" + u.command);
                                var D =
                                    "jqx-disableselect " +
                                    m.toThemeProperty(
                                        "jqx-editor-dropdownpicker"
                                ...
                                var I = b(
                                    '<div unselectable="on" style="z-index: 55;">'
                                );
                                var s =
                                    m.toThemeProperty(
                                        "jqx-editor-toolbar-icon"
                                    ...
                                    " " +
                                    m.toThemeProperty(
                                        "jqx-editor-toolbar-icon-" + u.command
                                    );
                                var O = b(
                                    "<div unselectable='on' class='" +
                                        s +
                                ...
                                I.append(O);
                                var L = b(
                                    '<div unselectable="on" class="jqx-editor-color-bar">'
                                )
                                    .attr("id", "bar-" + u.command)
                                    .css("background-color", u.value);
                                I.append(L);
                            ...
                            default:
                                ...
                                var w = b("<div unselectable='on'></div>")
                            ...
                            if (
                                ...
                                if (r.length > 2) {
                                    if (y == 0) {
                                        ...
                                        w.addClass(
                                            m.toThemeProperty("jqx-rc-l")
                                        );
                                    } else {
                                        if (y == r.length - 1) {
                                            w.css("border-left-radius", "0px");
                                            w.addClass(
                                                m.toThemeProperty("jqx-rc-r")
                                            );
                                        }
                                    }
                                    w.removeClass(
                                        m.toThemeProperty("jqx-rc-all")
                                    );
                                }
                                if (
                                    y != 0 &&
                ...
                if (p.length == 0) {
                    ...
                    for (var j = 0; j < p.length; j++) {
                        ...
                        var l = f.split(" ");
                        var o =
                            m.toThemeProperty("jqx-editor-toolbar-group") +
                            " " +
                            m.toThemeProperty("jqx-fill-state-normal");
        ...
        _arrange: function () {
            ...
            if (d.content) {
                if (d.tools == "" || d.tools == false) {
                    d.content.height(
                        d.container.outerHeight() -
                            parseInt(d.container.css("padding-top")) -
                            parseInt(d.container.css("padding-bottom")) -
                            6
                    );
                ...
                if (b.jqx.browser.msie && b.jqx.browser.version < 8) {
                    ...
                    d.content.height(
                        d.container.height() -
                            d.toolbar.outerHeight() -
                            2 * parseInt(d.container.css("padding-bottom")) -
                            10
                    );
                    d.content.width(
                        d.container.width() -
                            2 * parseInt(d.container.css("padding-left")) -
                            2
                    );
                }
        ...
        _addHandlers: function () {
            ...
            var f = function () {
                ...
                if (e.inline) {
                    e.host.removeClass(
                        e.toThemeProperty("jqx-fill-state-focus")
                    );
                    e.host.removeClass(
                        e.toThemeProperty("jqx-editor-inline-focus")
                    );
            ...
            e.addHandler(
                e.editor,
                "beforedeactivate.editor" + e.element.id,
                function (g) {
                    e.range = e.getRange();
                }
            );
            e.addHandler(e.editor, "mousedown.editor" + e.element.id, function (
                g
            ) {
                if (!g.target.href) {
                    if (e.linkPopup) {
            ...
            if (b.jqx.mobile.isTouchDevice()) {
                e.addHandler(
                    b(e.editorDocument),
                    "selectionchange.editor" + e.element.id,
                    function () {
                ...
                e.addHandler(
                    b(e.editorDocument),
                    "touchstart.editor" + e.element.id,
                    function () {
                        setTimeout(function () {
                            if (e.iframe) {
                                e.iframe[0].contentWindow.focus();
            ...
            e.addHandler(e.editor, "mouseup.editor" + e.element.id, function (
                g
            ) {
            ...
            e.addHandler(e.editor, "keydown.editor" + e.element.id, function (
                g
            ) {
                if (e.keyPressed) {
                    e.keyPressed(g);
                ...
                if (q == 13 && e.lineBreak != "default") {
                    ...
                    if (k) {
                        ...
                        while (p != null) {
                            ...
                            if (
                                p.parentNode == e.editorDocument.body ||
                                p == e.editorDocument.body
                            ) {
                                break;
                            }
                    ...
                    if (p) {
                        var j = e.getRange();
                        if (
                            e.editorDocument.body.innerHTML == "<div></div>" &&
                            e.lineBreak != "br"
                        ) {
                        ...
                        if (e.lineBreak == "div") {
                            if (p == e.editorDocument.body) {
                                b(p).append(
                                    "<div>&#8203;</div><span id='INSERTION_MARKER'>&nbsp;</span>"
                                );
                            } else {
                                b(
                                    "<div>&#8203;</div><span id='INSERTION_MARKER'>&nbsp;</span>"
                            ...
                            if (e.lineBreak == "p") {
                                if (p == e.editorDocument.body) {
                                    b(p).append(
                                        "<p>&#8203;</p><span id='INSERTION_MARKER'>&nbsp;</span>"
                                    );
                                } else {
                                    b(
                                        "<p>&#8203;</p><span id='INSERTION_MARKER'>&nbsp;</span>"
                                ...
                                e.execute(
                                    "insertHTML",
                                    "<br/>&#8203;<span id='INSERTION_MARKER'>&nbsp;</span>"
                                );
                            }
                        }
                        e.selectRange(j);
            ...
            e.addHandler(e.editor, "paste.editor" + e.element.id, function (g) {
                ...
                try {
                    ...
                    if (e.pasteMode == "text" && !b.jqx.browser.mozilla) {
                        e.selection.insertContent(
                            '<textarea cols="50" contenteditable="false" class="jqx-editor-paste-element"></textarea>'
                        );
                    } else {
                        e.selection.insertContent(
                            '<div class="jqx-editor-paste-element">&nbsp;</div>'
                        );
                    }
                    var n = b(window).scrollTop();
                    var i = b(e.editorDocument).find(
                        ".jqx-editor-paste-element"
                    );
                    i.css("top", n + "px");
                    ...
                    setTimeout(function () {
                        ...
                        if (e.pasteMode != "text") {
                            ...
                            if (
                                y.firstChild &&
                                y.firstChild.className ===
                                    "jqx-editor-paste-element"
                            ) {
                                var q = [];
                                for (
                                    var v = 0, t = y.childNodes.length;
                                    v < t;
                                    v++
                                ) {
                        ...
                        var w = e.getRange();
                        e.selection.insertContent(
                            r + "<span id='INSERTION_MARKER'>&nbsp;</span>"
                        );
                        e.marker.remove();
            ...
            e.addHandler(e.editor, "keyup.editor" + e.element.id, function (i) {
                ...
                if (
                    b.inArray(h.keyCode, j) != -1 ||
                    (h.keyCode == 65 && h.ctrlKey && !h.altKey && !h.shiftKey)
                ) {
            ...
            e.addHandler(e.editor, "dblclick.editor" + e.element.id, function (
                g
            ) {
                if (e._documentMode == "source") {
                    return true;
        ...
        _removeHandlers: function () {
            var d = this;
            if (d.editor) {
                d.removeHandler(d.editor, "paste.editor" + d.element.id);
                ...
                d.removeHandler(
                    d.editor,
                    "beforedeactivate.editor" + d.element.id
                );
        ...
        setStyleProperty: function (e, d) {
            ...
            if (
                d == "del" &&
                this.getParentByTag(e, "strike") &&
                this.getParentByTag(e, "strike").tagName.toLowerCase() ==
                    "strike"
            ) {
                this.style.del = !0;
            }
        ...
        updateStyle: function (f) {
            ...
            try {
                if (window.getComputedStyle) {
                    ...
                    var i =
                        d.getPropertyValue("font-weight") == 401
                            ? 700
                            : d.getPropertyValue("font-weight");
                    g.style = {
                    ...
                    g.style.del = g.isStyleProperty(
                        f,
                        "span",
                        "textDecoration",
                        "line-through"
                    );
                    g.style.u = g.isStyleProperty(
                        f,
                        "span",
                        "textDecoration",
                        "underline"
                    ...
                    var h = function (l) {
                        ...
                        while (
                            l &&
                            (window.getComputedStyle(l).backgroundColor == k ||
                                window.getComputedStyle(l).backgroundColor == e)
                        ) {
                            l = l.parentNode;
                        }
                        return l
                        ...
                        b.each(i, function (x, E) {
                            ...
                            switch (t.type) {
                                        ...
                                        if (t.command == "formatblock") {
                                            ...
                                            if (t.command == "fontsize") {
                                                ...
                                                try {
                                                    ...
                                                    if (C == -1) {
                                                        C =
                                                            k.editorDocument.queryCommandValue(
                                                                t.command
                                                            ) - 1;
                                                    }
                                                } catch (I) {}
                                ...
                                case "toggleButton":
                                    ...
                                    var q = false;
                                    var p =
                                        k.editorDocument.queryCommandState(
                                            t.command
                                        ) &&
                                        k.editorDocument.queryCommandEnabled(
                                            t.command
                                        );
                                    if (
                                        t.command == "createlink" &&
                                        ...
                                        if (y) {
                                            ...
                                            p = true;
                                            k.linkPopup = b(
                                                "<div class='jqx-editor-link-popup' contentEditable='false' style='overflow: hidden; white-space: nowrap; padding: 5px; height: 17px; font-size: 12px; color: #222222; background: #F5F5F5; position: absolute; z-index: 9999;'>" +
                                                    k.localization[
                                                        "Go to link"
                                                    ] +
                                                    ": <a target='_blank' style='color:#222222;' href='" +
                                                    e.href +
                                                    "'>" +
                                                    e.href +
                                                    "</a> - <a style='color:#222222;' href='#change'>" +
                                                    k.localization.Change +
                                                    "</a> - <a style='color:#222222;' href='#remove'>" +
                                                    k.localization.Remove +
                                                    "</a></div>"
                                            ).appendTo(k.editor);
                                            var u = b(e).coord();
                                            var v = u.left;
                                            if (
                                                u.left + k.linkPopup.width() >
                                                k.editor.width()
                                            ) {
                                                v =
                                                    k.editor.width() -
                                                ...
                                                function (K) {
                                                    if (
                                                        ...
                                                        switch (J) {
                                                            case 1:
                                                                k.editor.focus();
                                                                k.selection.selectNode(
                                                                    e,
                                                                    true
                                                                );
                                                                k.commands.link.widget.trigger(
                                                                    "click"
                                                                );
                                                                break;
                                                            case 2:
                                    ...
                                    if (
                                        ...
                                        if (G) {
                                            ...
                                            if (
                                                q &&
                                                k.range.collapsed === false
                                            ) {
                                                t.widget.jqxToggleButton(
                                                    "check"
                                                );
                                            } else {
                                                if (
        ...
        _addCommandHandler: function (g, f, j, i, d) {
            var e = this;
            var h;
            if (!j && d.init) {
                j = "custom";
            ...
            switch (j) {
                    ...
                    switch (d.type) {
                        case "list":
                            h = function (k) {
                                ...
                                e._preventDefault(k, false);
                            };
                            break;
                        case "colorPicker":
                            h = function (m) {
                                if (e._documentMode != "source") {
                                    var k = b(d.colorPicker)
                                        .find("td")
                                        .removeClass(
                                            "jqx-editor-color-picker-selected-cell"
                                        );
                                    if (
                                        m.target.nodeName.toLowerCase() == "div"
                                    ) {
                                        var l = b(m.target).css(
                                            "background-color"
                                        );
                                        b(m.target)
                                            .parent()
                        ...
                        default:
                            h = function (k) {
                                if (
                                    b(".jqx-editor-dropdownpicker").length > 0
                                ) {
                                    b(
                                        ".jqx-editor-dropdownpicker"
                                    ).jqxDropDownButton("close");
                ...
                case "fontsize":
                    h = function (k) {
                        if (e._documentMode != "source") {
                            if (k.args.type != "none") {
                                var m = b(this).val();
                                var n = "xx-small,x-small,small,medium,large,x-large,xx-large".split(
                                    ","
                                );
                                var l =
                                    b(this).jqxDropDownList(
                                        "getSelectedIndex"
                                    ) + 1;
                                var l = 1 + n.indexOf(m);
                                e.execute(b(this).attr("data-command"), l, d);
                            }
                        }
                        e._preventDefault(k, false);
                    };
                ...
                case "backcolor":
                    h = function (m) {
                        if (e._documentMode != "source") {
                            ...
                            if (m.target.nodeName.toLowerCase() == "div") {
                                var l = b(m.target).css("background-color");
                                b(m.target)
                                    .parent()
                                    .addClass(
                                        "jqx-editor-color-picker-selected-cell"
                ...
                case "viewsource":
                    h = function (k) {
                        ...
                        e.setMode(d.toggled);
                        if (b(".jqx-editor-dropdownpicker").length > 0) {
                            b(".jqx-editor-dropdownpicker").jqxDropDownButton(
                                "close"
                            );
                        }
                        if (b(".jqx-editor-dropdownlist").length > 0) {
                            b(".jqx-editor-dropdownlist").jqxDropDownList(
                                "close"
                            );
                        }
                        e._preventDefault(k);
                ...
                case "insertimage":
                    h = function (k) {
                        e._insertImageAction(k, e, d);
                    };
                    break;
                case "createlink":
                    h = function (k) {
                        e._createLinkAction(k, e, d);
                    };
                    break;
                default:
                    h = function (k) {
                        ...
                        e._preventDefault(k);
                        var n = b(this).attr("data-command");
                        var l = this;
                        if (e._documentMode != "source") {
                            if (n == "underline") {
                                if (e.getSelectedElement()) {
                                    var m = e.getSelectedElement();
                                    if (m && m.nodeName.toLowerCase() == "a") {
                                        if (d.toggled) {
                                            b(m).css("text-decoration", "none");
                                        } else {
                                            b(m).css(
                                                "text-decoration",
                                                "underline"
        ...
        _createLinkAction: function (d, k, l) {
            ...
            var m = b(
                "<div class='jqx-editor-window jqx-editor-link-window'><div>" +
                    k.localization["Insert Link"] +
                    "</div><div><table style='border-collapse: separate; border-spacing: 2px;'><tr><td align='right'>" +
                    k.localization.URL +
                    ":</td><td><input style='width: 200px; height: 23px;' value=''/></td><tr/><tr><td align='right'>" +
                    k.localization.Title +
                    ":</td><td><input style='width: 200px; height: 23px;' value=''/></td><tr/><tr><td align='right'></td><td><div class='jqx-editor-link-checkbox'>" +
                    k.localization["Open in a new window/tab"] +
                    "</div></td><tr/><tr><td align='right'></td><td align='right'><button>Ok</button><button style='margin-left: 5px;'>Remove</button><button style='margin-left: 5px;'>Cancel</button></td><tr/></table></div></div>"
            );
            ...
            var i = m
                .find(".jqx-editor-link-checkbox")
                .jqxCheckBox({ theme: k.theme, height: 23, width: 180 });
            var g = m
                .find("button:first")
                .jqxButton({ theme: k.theme, disabled: true });
            ...
            k.addHandler(
                h,
                !b.jqx.mobile.isTouchDevice()
                    ? "click"
                    : b.jqx.mobile.getTouchEventName("touchstart"),
                function (p) {
                    k.editor.focus();
            ...
            k.addHandler(
                ...
                function (s) {
                    ...
                    if (
                        q[0].value.indexOf("http") == -1 &&
                        q[0].value.indexOf("mailto") == -1
                    ) {
        ...
        _insertImageAction: function (j, i, g) {
            ...
            var h = b(
                "<div class='jqx-editor-window jqx-editor-image-window'><div>" +
                    i.localization["Insert Image"] +
                    "</div><div><table style='border-collapse: separate; border-spacing: 2px;'><tr><td align='right'>" +
                    i.localization.URL +
                    ":</td><td><input style='width: 180px; height: 23px;' value=''/></td><tr/><tr><td align='right'>" +
                    ...
                    ":</td><td><input style='width: 180px; height: 23px;' class='jqx-editor-hspace'/></td><tr/><tr><td align='right'>" +
                    i.localization.VSpace +
                    ":</td><td><input style='width: 180px; height: 23px;' class='jqx-editor-vspace'/></td><tr/><tr><td align='right'>" +
                    i.localization.Align +
                    ":</td><td><div class='jqx-editor-align'></div></td><tr/><tr><td align='right'></td><td align='right'><button>Ok</button><button style='margin-left: 5px;'>Remove</button><button style='margin-left: 5px;'>Cancel</button></td><tr/></table></div></div>"
            );
            ...
            h.find(".jqx-editor-align").jqxDropDownList({
                ...
                width: 180,
                source: [
                    i.localization["not set"],
                    i.localization.Left,
                    i.localization.Right,
                ],
            });
            ...
            i.addHandler(
                ...
                function (o) {
                    ...
                    var p = i.editImage
                        ? b(i.editImage)
                        : b('<img style="border: 1px solid transparent;">');
                    var n = p
                        .attr("src", m[0].value)
                        .attr("unselectable", "on");
                    if (m[1].value) {
        ...
        editmode: function (f) {
            ...
            if (!f && !e.readOnly) {
                ...
                var g = b("<pre>");
                g.html(d)
                    .attr({ id: "sourceText", contentEditable: true })
                    .css("height", "100%");
                e.editor.html(g);
            ...
            if (!g.readOnly) {
                ...
                var d = function (m) {
                    try {
                        if (
                            m.command &&
                            m.command.toLowerCase() == "inserthtml"
                        ) {
                            var l = g.getRange();
                            var n = m.value;
                    ...
                    switch (m.type) {
                        ...
                        default:
                            ...
                            if (m.command === "insertimage") {
                                if (
                                    b("#imageWindow" + h.element.id).length > 0
                                ) {
                                    b("#imageWindow" + h.element.id)
                                        .find(".jqx-editor-align")
                                ...
                                if (m.command === "createlink") {
                                    if (
                                        b("#linkWindow" + h.element.id).length >
                                        0
                                    ) {
                                        b("#linkWindow" + h.element.id)
                                            .find(".jqx-editor-align")
                                            .jqxDropDownList("destroy");
                                        b("#linkWindow" + h.element.id)
                                            .find("button")
        ...
        val: function (e) {
            if (e !== undefined && e === "source") {
                var d = this.editor[0];
                if (this._documentMode === "source") {
                    d = this.editor.find("pre:first")[0];
                }
                var g = new c();
                var f = g.HTMLtoXML(d.innerHTML);
                f = g.FormatHTML(f);
                return f;
            }
        ...
        _raiseEvent: function (i, e) {
            ...
            h.args = g;
            if (this._textArea) {
                var d = b(this._textArea).trigger(h);
            } else {
        ...
        this.FormatHTML = function (D, r) {
            ...
            function q() {
                ...
                this.get_tag = function () {
                    ...
                    if (
                        P.charAt(P.length - 2) === "/" ||
                        this.Utils.in_array(N, this.Utils.single_token)
                    ) {
            ...
            while (true) {
                ...
                switch (H.token_type) {
                    ...
                    case "TK_TAG_END":
                        if (
                            H.last_token === "TK_CONTENT" &&
                            H.last_text === ""
                        ) {
                            var F = H.token_text.match(/\w+/)[0];
                            var y = H.output[H.output.length - 1].match(
                                /<\s*(\w+)/
                            );
                            if (y === null || y[1] !== F) {
