    ...
    (function (bd, G) {
        ...
        C.fn = C.prototype = {
                ...
                if (typeof bu === "string") {
                    ...
                    if (bw && (bw[1] || !bx)) {
                        if (bw[1]) {
                            ...
                            bA =
                                bx && bx.nodeType ? bx.ownerDocument || bx : ak;
            ...
            pushStack: function (bv, bx, bu) {
                ...
                if (bx === "find") {
                    bw.selector =
                        this.selector + (this.selector ? " " : "") + bu;
                } else {
                    if (bx) {
                ...
                if ((bD = arguments[by]) != null) {
                    for (bw in bD) {
                        ...
                        if (
                            bC &&
                            bv &&
                            (C.isPlainObject(bv) || (bA = C.isArray(bv)))
                        ) {
                            if (bA) {
                                bA = false;
        ...
        C.extend({
            ...
            parseHTML: function (bx, bw, bu) {
                ...
                return C.merge(
                    [],
                    (bv.cacheable ? C.clone(bv.fragment) : bv.fragment)
                        .childNodes
                );
            },
            parseJSON: function (bu) {
                ...
                if (
                    j.test(bu.replace(a5, "@").replace(K, "]").replace(t, ""))
                ) {
            ...
            nodeName: function (bv, bu) {
                return (
                    bv.nodeName &&
                    bv.nodeName.toLowerCase() === bu.toLowerCase()
                );
            },
                ...
                var bw = 0,
                    ...
                    bx = function (bF, bG, bE) {
                        return function (bH) {
                            bG[bF] = this;
                            bE[bF] =
                                arguments.length > 1 ? aD.call(arguments) : bH;
                            if (bE === bC) {
                                bD.notifyWith(bG, bE);
                            } else {
                                if (!--bv) {
        ...
        C.support = (function () {
            ...
            bG = {
                ...
                html5Clone:
                    ak.createElement("nav").cloneNode(true).outerHTML !==
                    "<:nav></:nav>",
            ...
            C(function () {
                ...
                if (bd.getComputedStyle) {
                    bG.pixelPosition =
                        (bd.getComputedStyle(bM, null) || {}).top !== "1%";
                    bG.boxSizingReliable =
                        (bd.getComputedStyle(bM, null) || { width: "4px" })
                            .width === "4px";
                ...
                if (typeof bM.style.zoom !== "undefined") {
                    bM.innerHTML = "";
                    bM.style.cssText =
                        bJ + "width:1px;padding:1px;display:inline;zoom:1";
        ...
        C.extend({
            ...
            acceptData: function (bv) {
                ...
                return (
                    !bu || (bu !== true && bv.getAttribute("classid") === bu)
                );
            },
        });
        C.fn.extend({
            ...
            toggleClass: function (bx, bv) {
                ...
                if (C.isFunction(bx)) {
                    return this.each(function (by) {
                        C(this).toggleClass(
                            bx.call(this, by, this.className, bv),
                            bv
                        );
                    });
                }
            ...
            val: function (bx) {
                ...
                if (!arguments.length) {
                    if (bw) {
                        bu =
                            C.valHooks[bw.type] ||
                            C.valHooks[bw.nodeName.toLowerCase()];
                        if (
                            bu &&
                            "get" in bu &&
                            (bv = bu.get(bw, "value")) !== G
                        ) {
                            return bv;
                        }
                        bv = bw.value;
        ...
        C.event = {
            add: function (bx, bB, bI, bz, by) {
                ...
                for (bH = 0; bH < bB.length; bH++) {
                    ...
                    bF = C.extend(
                        {
                            ...
                            selector: by,
                            needsContext:
                                by && C.expr.match.needsContext.test(by),
                            namespace: bu.join("."),
                        },
                        bv
                    );
                    ...
                    if (!bw) {
                        ...
                        if (
                            !bD.setup ||
                            bD.setup.call(bx, bz, bu, bA) === false
                        ) {
            ...
            remove: function (bx, bC, bI, by, bB) {
                ...
                for (bJ = 0; bJ < bC.length; bJ++) {
                    ...
                    if (bu.length === 0 && bz !== bu.length) {
                        if (
                            !bE.teardown ||
                            bE.teardown.call(bx, bv, bD.handle) === false
                        ) {
            ...
            trigger: function (bv, bC, bA, bJ) {
                ...
                for (
                    bD = 0;
                    bD < bB.length && !bv.isPropagationStopped();
                    bD++
                ) {
                    bH = bB[bD][0];
                    bv.type = bB[bD][1];
                    bE =
                        (C._data(bH, "events") || {})[bv.type] &&
                        C._data(bH, "handle");
                    if (bE) {
                        bE.apply(bH, bC);
                    }
                ...
                if (!bJ && !bv.isDefaultPrevented()) {
                    if (
                        (!bF._default ||
                            bF._default.apply(bA.ownerDocument, bC) ===
                                false) &&
            ...
            dispatch: function (bu) {
                ...
                for (
                    bB = 0;
                    bB < bH.length && !bu.isPropagationStopped();
                    bB++
                ) {
                    bv = bH[bB];
                    ...
                    for (
                        bA = 0;
                        bA < bv.matches.length &&
                        !bu.isImmediatePropagationStopped();
                        bA++
                    ) {
                        bI = bv.matches[bA];
                        if (
                            ...
                            (bu.namespace_re &&
                                bu.namespace_re.test(bI.namespace))
                        ) {
                            bu.data = bI.data;
                            bu.handleObj = bI;
                            bE = (
                                (C.event.special[bI.origType] || {}).handle ||
                                bI.handler
                            ).apply(bv.elem, bG);
                            if (bE !== G) {
                                bu.result = bE;
            ...
            keyHooks: {
                ...
                filter: function (bv, bu) {
                    if (bv.which == null) {
                        bv.which =
                            bu.charCode != null ? bu.charCode : bu.keyCode;
                    }
                    return bv;
                },
            },
        ...
        C.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function (
            bv,
            bu
        ) {
            C.event.special[bv] = {
        ...
        C.fn.extend({
            ...
            toggle: function (bx) {
                var bv = arguments,
                    ...
                    by = function (bz) {
                        var bA =
                            (C._data(this, "lastToggle" + bx.guid) || 0) % bw;
                    ...
                    if ((cI = cj.exec(cF))) {
                        if ((cE = cI[1])) {
                            if (cG === 9) {
                                ...
                                if (
                                    cC.ownerDocument &&
                                    (cD = cC.ownerDocument.getElementById(
                                        cE
                                    )) &&
                                    b5(cC, cD) &&
                                    cD.id === cE
                            ...
                            if (cI[2]) {
                                cr.apply(
                                    cH,
                                    bQ.call(cC.getElementsByTagName(cF), 0)
                                );
                                return cH;
                            } else {
                                if (
            ...
            cg = cl.selectors = {
                ...
                find: {
                    ...
                    CLASS:
                        ...
                        function (cE, cD, cC) {
                            if (
                                typeof cD.getElementsByClassName !== bZ &&
                                !cC
                            ) {
                ...
                filter: {
                    ...
                    TAG: function (cC) {
                        ...
                        return function (cD) {
                            return (
                                cD.nodeName && cD.nodeName.toLowerCase() === cC
                            );
                        };
                    },
                    CLASS: function (cC) {
                    ...
                    PSEUDO: function (cF, cE) {
                        ...
                        if (cD.length > 1) {
                            cC = [cF, cF, "", cE];
                            return cg.setFilters.hasOwnProperty(
                                cF.toLowerCase()
                            )
                                ? cw(function (cI, cK) {
                                      var cH,
            ...
            function ct(cE, cC, cG, cK, cJ) {
                ...
                if (!cK) {
                    if (cI.length === 1) {
                        ...
                        for (
                            cH = cb.POS.test(cE) ? -1 : cN.length - 1;
                            cH >= 0;
                            cH--
                        ) {
                            cD = cN[cH];
                ...
                (function () {
                    ...
                    ct = function (cP, cK, cR, cU, cT) {
                        if (!cU && !cT && !cD.test(cP)) {
                            ...
                            if (
                                cK.nodeType === 1 &&
                                cK.nodeName.toLowerCase() !== "object"
                            ) {
                                cN = bw(cP);
                            ...
                            if (cQ) {
                                try {
                                    cr.apply(
                                        cR,
                                        bQ.call(cL.querySelectorAll(cQ), 0)
                                    );
                                    return cR;
                                } catch (cO) {
                                } finally {
                ...
                if (!C.support.appendChecked) {
                    for (bE = 0; (bG = bI[bE]) != null; bE++) {
                        if (C.nodeName(bG, "input")) {
                            ...
                            if (
                                typeof bG.getElementsByTagName !== "undefined"
                            ) {
                        ...
                        if (!(C.nodeName(bG, "script") && bJ(bG))) {
                            ...
                            if (
                                ...
                                bC = C.grep(
                                    C.merge(
                                        [],
                                        bG.getElementsByTagName("script")
                                    ),
                                    bJ
                                );
        ...
        function ap(bv, bu) {
            bv = bu || bv;
            return (
                C.css(bv, "display") === "none" ||
                !C.contains(bv.ownerDocument, bv)
            );
        }
        function bb(bz, bu) {
            var by,
        ...
        function aZ(bx, bv, bu, bz) {
            ...
            for (; bw < 4; bw += 2) {
                ...
                if (bz) {
                    ...
                    if (bu !== "margin") {
                        by -=
                            parseFloat(Q(bx, "border" + D[bw] + "Width")) || 0;
                    }
                } else {
                    by += parseFloat(Q(bx, "padding" + D[bw])) || 0;
                    if (bu !== "padding") {
        ...
        function Y(bx, bv, bu) {
            ...
            return (
                by + aZ(bx, bv, bu || (bz ? "border" : "content"), bw) + "px"
            );
        }
        function aN(bw) {
            if (J[bw]) {
            ...
            C.expr.filters.hidden = function (bu) {
                return (
                    ...
                    (!C.support.reliableHiddenOffsets &&
                        ((bu.style && bu.style.display) || Q(bu, "display")) ===
                            "none")
                );
            };
        ...
        C.param = function (bu, bw) {
            var bx,
                ...
                by = function (bz, bA) {
                    ...
                    bv[bv.length] =
                        encodeURIComponent(bz) + "=" + encodeURIComponent(bA);
                };
            if (bw === G) {
        ...
        function bj(bw, bA, bD) {
            ...
            C.fx.timer(
                C.extend(by, { anim: bx, queue: bx.opts.queue, elem: bw })
            );
            return bx
                    ...
                    C.fn[bx] = function (bB, bA) {
                        ...
                        return C.access(
                            ...
                            function (bD, bC, bE) {
                                var bF;
                                if (C.isWindow(bD)) {
                                    return bD.document.documentElement[
                                        "client" + bu
                                    ];
                                }
                                if (bD.nodeType === 9) {
...
(function (b) {
    ...
    b.jqx.jqxWidget = function (c, d, g) {
            ...
            a[h] = window[h] = function (e, s) {
                ...
                if (window.jqxWidgets && window.jqxWidgets[o]) {
                    ...
                    if (window.jqxWidgets[o].length == 1) {
                        var q = b(
                            window.jqxWidgets[o][0].widgetInstance.element
                        ).data();
                        if (q && q.jqxWidget) {
                ...
                if (p.length === 0) {
                    ...
                    if (h === "jqxSplitter") {
                        p = b(
                            "<div><div>Panel 1</div><div>Panel 2</div></div>"
                        );
                    }
                    if (h === "jqxTabs") {
                        p = b(
                    ...
                    if (h === "jqxWindow") {
                        p = b(
                            "<div><div>Title 1</div><div>Content 1</div></div>"
                        );
                    }
                }
                var r = [];
                b.each(p, function (w) {
                    ...
                    if (!k[h]) {
                        ...
                        if (h == "jqxDockingLayout") {
                            x = b.extend(
                                x,
                                b.jqx._jqxLayout.prototype.defineInstance()
                            );
                        }
                        if (h == "jqxToggleButton" || h == "jqxRepeatButton") {
                            x = b.extend(
                                x,
                                b.jqx._jqxButton.prototype.defineInstance()
                            );
                        }
                        if (h == "jqxTreeGrid") {
                            x = b.extend(
                                x,
                                b.jqx._jqxDataTable.prototype.defineInstance()
                            );
                        }
                        var t = function (A) {
                                    ...
                                    if (
                                        ...
                                        if (G || f(F) != f(E)) {
                                            ...
                                            if (
                                                ...
                                                this.widgetInstance.propertyUpdated(
                                                    A,
                                                    F,
                                                    H
                                                );
        ...
        try {
            b.extend(
                b.jqx["_" + h].prototype,
                Array.prototype.slice.call(g, 0)[0]
            );
        } catch (i) {}
                ...
                if (q === true) {
                    if (m != -1) {
                        ...
                        if (
                            ...
                            this.watchedElementData.length > 0
                        ) {
                        ...
                        if (w === undefined || w !== true) {
                            if (D) {
                                ...
                                if (l.watchedElementData) {
                                    for (
                                        var z = 0;
                                        z < l.watchedElementData.length;
                                        z++
                                    ) {
                                        if (
                                            l.watchedElementData[z].element ==
                                            B.jqxWidget.element
                                        ) {
                                            l.watchedElementData[
                                                z
                                            ].offsetWidth =
                                ...
                                if (l.hiddenWidgets.indexOf(I) >= 0) {
                                    l.hiddenWidgets.splice(
                                        l.hiddenWidgets.indexOf(I),
                                        1
                                    );
                                }
                            }
    ...
    b.extend(b.jqx.mobile, {
        ...
        getTopPos: function (d) {
            ...
            if (this.isSafariMobileBrowser()) {
                ...
                if (
                    e.indexOf("version/6") != -1 ||
                    e.indexOf("version/5") != -1
                ) {
                    f = f + b(window).scrollTop();
                }
                if (
                    /(Android.*Chrome\/[.0-9]* (!?Mobile))/.exec(
                        navigator.userAgent
                    )
                ) {
        ...
        isOperaMiniMobileBrowser: function () {
            var d = navigator.userAgent.toLowerCase();
            var c =
                d.indexOf("opera mini") != -1 || d.indexOf("opera mobi") != -1;
            return c;
        },
        ...
        getTouches: function (c) {
            ...
            if (!c.touches) {
                c.touches = new Array();
                c.touches[0] =
                    c.originalEvent != undefined ? c.originalEvent : c;
        ...
        touchScroll: function (B, M, Z, H, x, n) {
            ...
            function A(am) {
                if (am.targetTouches && am.targetTouches.length >= 1) {
                    ...
                    if (
                        am.originalEvent &&
                        am.originalEvent.clientY !== undefined
                    ) {
            ...
            function ae(am) {
                if (am.targetTouches && am.targetTouches.length >= 1) {
                    ...
                    if (
                        am.originalEvent &&
                        am.originalEvent.clientX !== undefined
                    ) {
            ...
            var X = function (am) {
                ...
                var ao = an[0];
                if (an.length == 1) {
                    G.dispatchMouseEvent(
                        "mousedown",
                        ao,
                        G.getRootNode(ao.target)
                    );
                }
        ...
        containsIgnoreCase: function (c, d) {
            ...
            return (
                c
                    .toString()
                    .toUpperCase()
                    .indexOf(d.toString().toUpperCase()) != -1
            );
        },
        equals: function (c, d) {
            if (c == null || d == null) {
...
(function (b) {
    ...
    b.fn.val = function (d) {
        if (typeof d == "undefined") {
            ...
            if (
                this[0] &&
                this[0].tagName.toLowerCase().indexOf("angular") >= 0
            ) {
    ...
    b.fn.coord = function (n) {
        ...
        return {
            top:
                c + i.top + (j.pageYOffset || e.scrollTop) - (e.clientTop || 0),
            left:
                h +
                i.left +
                (j.pageXOffset || e.scrollLeft) -
                (e.clientLeft || 0),
        };
    };
    b.jqx.ripplers = [];
        ...
        e.on("mousedown.ripple", function (i) {
            ...
            setTimeout(function () {
                ...
                if (o === "checkbox" || o === "radiobutton") {
                    ...
                    r.css({ top: t + "px", left: q + "px" }).addClass(
                        "animate"
                    );
